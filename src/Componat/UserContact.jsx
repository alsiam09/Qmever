                ...
                Edit === true
                    ? <div className="yourCon w-[100%]">
                        ...
                        <div className="Division justify-between my-[10px]">
                            <h4 ref={selectDivRef} className=' rounded-[10px] text-[#000] px-[20px] bg-[#efebeb] text-[15px] md:text-[20px] lg:text-[26px] font-sans flex justify-between items-center'><h5>Your District</h5><h5 className='pt-[3px]'>{DivSelect === true ?<h5 className=''><IoIosArrowUp /></h5>: <h5 className=''><IoIosArrowDown /></h5> }</h5></h4>
                            {DivSelect === true ?
                            divisions.map((item, index) => (
                                <h5 onClick={() => HandleDiv({item , index})} className='w-[100%] h-[30px] flex justify-end items-center my-[1px]' >{item.name}</h5>
                            ))
                            :
                            ""
                            }
                        ...
                        <h4 ref={selectDisRef} className=' rounded-[10px] text-[#000] px-[20px] bg-[#efebeb] text-[15px] md:text-[20px] lg:text-[26px] font-sans flex justify-between items-center'><h5>Your Division</h5><h5 className='pt-[3px]'>{DivSelect === true ?<h5 className=''><IoIosArrowUp /></h5>: <h5 className=''><IoIosArrowDown /></h5> }</h5></h4>
                            {DisSelect === true ?
                            district.map((item, index) => (
                                <h5 onClick={() => HandleDis({item , index})} className={` ${item.division_id === indexArea ? "block" : "hidden"} w-[100%] h-[30px] flex justify-end items-center my-[1px]`} >{item.name}</h5>
                            ))
                            :
                            ""
                            }
                        ...
                        <div className="District justify-between my-[10px]">
                        <h4 ref={selectupaRef} className=' rounded-[10px] text-[#000] px-[20px] bg-[#efebeb] text-[15px] md:text-[20px] lg:text-[26px] font-sans flex justify-between items-center'><h5>Your upazila</h5><h5 className='pt-[3px]'>{DivSelect === true ?<h5 className=''><IoIosArrowUp /></h5>: <h5 className=''><IoIosArrowDown /></h5> }</h5></h4>
                            {upaSelect === true ?
                            upazila.map((item , index) => (
                                <h5 onClick={() => HandleUpa({item , index})} className={` ${item.district_id === districtid ? "block" : "hidden"} w-[100%] h-[30px] flex justify-end items-center my-[1px]`} >{item.name}</h5>
                            ))
                            :
                            ""
                            }
