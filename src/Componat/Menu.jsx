      ...
      <section className='w-[100%] h-[60px] sm:h-[70px] md:h-[80px]'>
        <div className=' z-[999] px-[10px] bg-[#000] fixed top-0 left-[50%] translate-x-[-50%] w-[100%] '>
          <div className=" relative container mx-auto h-[60px] sm:h-[70px] md:h-[80px]">
            ...
            <h1 className='text-[#ff1586] uppercase text-[30px] underline font-[700]'>Shohosrodhra</h1>
            </div>
      ...
      {MenuShow === true ?
        <div className="fixed w-[200px] sm:w-[300px] md:w-[400px] 2xl:w-[600px] h-[100%] bg-[#fff] duration-300 right-0 top-0 z-[999]">
          ...
          <ul className='w-[100%] mt-[60px]'>
          {
            ...
            <li className=' font-sans text-[22px] px-[20px] py-[5px] rounded-[10px] m-[10px] hover:bg-[#00000013] font-[700]'>My Order</li>
