...
const BuyProDucts = ({ BuyItem , building_data , TotalBuild , HandleSendOTP }) => {
  ...
  return (
    <div className="BuyProDuct w-[100%] md:w-[40%]">
      {BuyItem.map((Buyitemuser) => (
       ...
       <h2 className=' pl-[10px] flex items-center h-[30px] text-[#000]'>Total Price : {Buyitemuser.Pricesub !== "" && Buyitemuser.Pricesub ? Buyitemuser.Pricesub : Buyitemuser.Price}৳</h2>
         <h2 className=' pl-[10px] flex items-center h-[30px] text-[#000]'>Vat : {building_data.VAT} ৳</h2>
         <h2 className=' pl-[10px] flex items-center h-[30px] text-[#000]'>delivery charges : {building_data.delivery_charges} ৳</h2>
         <h2 className=' pl-[10px] flex items-center h-[30px] text-[#000]'>Total build : {TotalBuild} ৳</h2>
       <div className='flex items-center gap-[10px]'><h3 className=' w-[20px] h-[20px] rounded-[50%] border-[2px] border-[red]' ></h3><h3 className='text-[18px] text-[#000]'>Cash on delivery</h3></div>
         ...
         <h2 className=' pl-[10px] flex items-center h-[30px] text-[#000]'>Price : {Buyitemuser.Pricesub !== "" && Buyitemuser.Pricesub ? Buyitemuser.Pricesub : Buyitemuser.Price}৳</h2>
         <h2 className=' pl-[10px] flex items-center h-[30px] text-[#000]'>Vat : {building_data.VAT} ৳</h2>
         <h2 className=' pl-[10px] flex items-center h-[30px] text-[#000]'>delivery charges : {building_data.delivery_charges} ৳</h2>
         <h2 className=' pl-[10px] flex items-center h-[30px] text-[#000]'>Total build : {TotalBuild} ৳</h2>
