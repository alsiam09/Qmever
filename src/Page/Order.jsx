    ...
    return (
        <div className='text-[#fff] container mx-auto ' >
            <div className=" w-[100%] h-[80px] bg-[#f8f6f6] rounded-[10px] my-[40px] flex justify-around items-center ">
                ...
                <h2 className=' px-[15px] border-[#000] border-[3px] h-[40px] flex justify-center items-center rounded-[10px] bg-[#000] text-[17px] text-[red] font-[600] hover:text-[red] hover:bg-[#fff] hover:border-[3px] cursor-pointer hover:border-[red] ' >Cancel</h2>
            </div>
            {
                orderItems.map((item) => (
                            ...
                            <div className=" my-[20px] ">
                                <div className=" flex justify-between">
                                    ...
                                    <div className="w-[20%] flex items-center justify-end">
                                        <div className="">
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${item.orderStatus === "Delivered" && " bg-[green] "} ${item.orderStatus === "Shipped" && " bg-[green] "} ${item.orderStatus === "Dispatched" && " bg-[green] "} ${item.orderStatus === "Picking" && " bg-[green] "} ${item.orderItems === "Confirmed" && "bg-[green]"} ${item.orderStatus === "Processing" && "bg-[green]"} ${item.orderStatus === "Placed" && " bg-[green] "} text-[#fff] py-[10px] px-[30px] text-[17px] font-[600]`}>Placed</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${item.orderStatus === "Delivered" && " bg-[green] "} ${item.orderStatus === "Shipped" && " bg-[green] "} ${item.orderStatus === "Dispatched" && " bg-[green] "} ${item.orderStatus === "Picking" && " bg-[green] "} ${item.orderItems === "Confirmed" && "bg-[green]"} ${item.orderStatus === "Processing" && "bg-[green]"} text-[#fff] py-[10px] px-[30px] text-[17px] font-[600]`}>Processing</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${item.orderStatus === "Delivered" && " bg-[green] "} ${item.orderStatus === "Shipped" && " bg-[green] "} ${item.orderStatus === "Dispatched" && " bg-[green] "} ${item.orderStatus === "Picking" && " bg-[green] "} ${item.orderItems === "Confirmed" && "bg-[green]"} text-[#fff] py-[10px] px-[30px] text-[17px] font-[600]`}>Confirmed</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${item.orderStatus === "Delivered" && " bg-[green] "} ${item.orderStatus === "Shipped" && " bg-[green] "} ${item.orderStatus === "Dispatched" && " bg-[green] "} ${item.orderStatus === "Picking" && " bg-[green] "}  text-[#fff] py-[10px] px-[30px] text-[17px] font-[600]`}>Picking</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${item.orderStatus === "Delivered" && " bg-[green] "} ${item.orderStatus === "Shipped" && " bg-[green] "} ${item.orderStatus === "Dispatched" && " bg-[green] "}  text-[#fff] py-[10px] px-[30px] text-[17px] font-[600]`}>Dispatched</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${item.orderStatus === "Delivered" && " bg-[green] "} ${item.orderStatus === "Shipped" && " bg-[green] "} text-[#fff] py-[10px] px-[30px] text-[17px] font-[600]`}>Shipped</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${item.orderStatus === "Delivered" && " bg-[green] "} text-[#fff] py-[10px] px-[30px] text-[17px] font-[600]`}>Delivered</h2>
                                        </div>
