                        ...
                        <div className=" my-[20px] ">
                                <div className=" flex justify-between">
                                    ...
                                    <div className="w-[20%] flex items-center justify-end">
                                        <div className="">
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${orders.orderStatus === "Delivered" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Shipped" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Dispatched" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Picking" && " bg-[green] text-[#fff]"} ${orders.orderItems === "Confirmed" && "bg-[green] text-[#fff] "} ${orders.orderStatus === "Processing" && "bg-[green] text-[#fff]"} ${orders.orderStatus === "Placed" && " bg-[green] text-[#fff] "} text-[#000] py-[10px] px-[30px] text-[17px] font-[600]`}>Placed</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${orders.orderStatus === "Delivered" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Shipped" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Dispatched" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Picking" && " bg-[green] text-[#fff]"} ${orders.orderItems === "Confirmed" && "bg-[green] text-[#fff] "} ${orders.orderStatus === "Processing" && "bg-[green] text-[#fff]"} text-[#000] py-[10px] px-[30px] text-[17px] font-[600]`}>Processing</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${orders.orderStatus === "Delivered" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Shipped" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Dispatched" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Picking" && " bg-[green] text-[#fff]"} ${orders.orderItems === "Confirmed" && "bg-[green] text-[#fff] "} text-[#000] py-[10px] px-[30px] text-[17px] font-[600]`}>Confirmed</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${orders.orderStatus === "Delivered" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Shipped" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Dispatched" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Picking" && " bg-[green] text-[#fff]"}  text-[#000] py-[10px] px-[30px] text-[17px] font-[600]`}>Picking</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${orders.orderStatus === "Delivered" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Shipped" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Dispatched" && " bg-[green] text-[#fff] "}  text-[#000] py-[10px] px-[30px] text-[17px] font-[600]`}>Dispatched</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${orders.orderStatus === "Delivered" && " bg-[green] text-[#fff] "} ${orders.orderStatus === "Shipped" && " bg-[green] text-[#fff] "} text-[#000] py-[10px] px-[30px] text-[17px] font-[600]`}>Shipped</h2>
                                            <h2 className={` flex justify-start rounded-[30px] mx-[10px] my-[5px] ${orders.orderStatus === "Delivered" && " bg-[green] text-[#fff] "} text-[#000] py-[10px] px-[30px] text-[17px] font-[600]`}>Delivered</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className=" flex justify-between">
                                    <div className="prode border-[#ffffff78] border-[2px] rounded relative w-[80%]">
                                        ...
                                        {OrderStatus.map((item , index)=>(
                                            ...
                                            <h2 className='text-[#ff1586] text-[17px] w-[200px] flex justify-center text-[600] absolute top-[10px] right-[140px] rounded-[30px] bg-[#0000001f]  py-[5px]'>{item.Price}৳</h2>
                                        </div>
                                        <div className="m-[10px] flex gap-[20px] items-center">
                                            <img className='w-[100px]' src={item.imgurl} alt="" />
                                            <h2 className=' text-[#000] ' >{item.Prodectname}</h2>
                                            <h2 className=' text-[#000] ' >{item.Price}৳</h2>
                                        </div>
                                    </div>
                                    <div className="w-[20%] flex items-center justify-end">
                                        <div className="">
