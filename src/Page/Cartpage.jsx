...
const Cartpage = () => {
  ...
  return (
    <section>
      ...
      <div className=" hidden sm:block border-b-[2px] border-b-[#ffffff81] ">
      ...
      {cartItem.map((cartItemx , index)=>(
            <div className="">
              <div className="box justify-between w-[100%] my-[10px] md:m-[10px] flex flex-wrap p-[10px] items-center gap-[10px]">
                ...
                <h2 className=' sm:pr-[10px] flex items-center h-[70px] text-[#fff]'>{cartItemx.Prodectname}</h2>
                </div>
                <h2 className=' justify-start sm:w-[20%] pr-[10px] flex items-center h-[70px] text-[#fff]'>
                  {
                    cartItemx.ModelName
                ...
                <div className=' justify-start sm:w-[20%] pr-[10px] flex items-center h-[70px] text-[#fff]'>
                ...
                <h2 className=' justify-end sm:w-[20%] pr-[10px] flex items-center h-[70px] text-[#fff]'>Price : {cartItemx.Pricesub !== "" && cartItemx.Pricesub ? cartItemx.Pricesub * cartItemx.ProdectQun : cartItemx.Price * cartItemx.ProdectQun}৳</h2>
            </div>
            </div>
        ))}
        
        <div className="TotalBillbox my-[30px] mx-[10px] flex justify-end">
          <h2 onClick={HandleCheckoutGo} className="Total rounded sm:w-[20%] flex justify-center items-center p-[7px] border-[2px] bg-[#ff1586] sm:text-[19px] font-[600] text-[#ffffffd3] border-[#fff]">Procces to CheckOut</h2>
        </div>
      </div>
    </section>
  )
